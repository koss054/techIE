...
namespace techIE.Data.Migrations
{
    ...
    [Migration("20221209202756_RemoveIsCurrentFromOrder")]
    partial class RemoveIsCurrentFromOrder
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("techIE.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "939db98c-a852-4492-9c08-e2596b7f735b",
                            Email = "admin@techie.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "admin@techie.com",
                            NormalizedUserName = "Admin",
                            PasswordHash = "AQAAAAEAACcQAAAAEL3PfUycXEcpcdN+eEWQ2GU7kQC0tt2ImJDMHAvbWCb1snkhLGsVphgSAO8NBqGnKw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "2a70481a-462f-4a5c-bba7-e63f564a4a3c",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("techIE.Data.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("techIE.Data.Entities.Product", b =>
                {
                    b.HasOne("techIE.Data.Entities.Category", "Category")
                        .WithMany()
